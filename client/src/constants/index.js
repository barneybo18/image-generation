export const surpriseMePrompts = [
    ...
    "A futuristic cityscape where nature and technology coexist.",
    "An underwater world with bioluminescent creatures.",
    "Steampunk-inspired flying machines in a Victorian-era setting.",,
    "A serene forest with a hidden fairy village.",
    "A post-apocalyptic landscape reclaimed by wildlife.",
    "Extraterrestrial life on a distant planet.",
    "A bustling cyberpunk street market at night.",
    "An enchanted forest with talking animals.",
    "A retro-futuristic space station orbiting a gas giant.",
    "A desert oasis with nomadic tribes and ancient ruins.",
    "A parallel universe where gravity works differently.",
    "A medieval castle in a snowy mountain landscape.",
    "A whimsical carnival in a floating sky city.",
    "A surreal dreamscape with impossible geometry.",
    "A time-traveling explorer in ancient Egypt.",
    "A sunken pirate ship in a coral reef.",
    "A mythical creature based on elements of fire and water.",
    "A modern city skyline with a twist of fantasy.",
    "An alternate history where dinosaurs coexist with humans.",
    "A high-tech laboratory deep in the rainforest.",
  ];
