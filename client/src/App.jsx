...
import { Home, CreatePost } from './pages'
 ...
 const App = () => {
  return (
        <BrowserRouter>
          <header className='w-full flex justify-between items-center bg-white sm:px-8 px-4 py-4 border-b border-b-[#e6ebf4] fixed z-[9999]'>
            <Link to="/">
              <img src={logo} alt="logo" className='w-[180px] object-contain' />
            </Link>

            
            <Link to="/createpost" className='font-inter font-medium bg-gradient-to-r from-sky-500 via-50% to-indigo-500 to-55% text-white px-4 py-2 rounded-md'>Create</Link>
          </header>
